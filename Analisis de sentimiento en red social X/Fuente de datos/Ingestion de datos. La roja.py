...
query = "#larojasub20 -is:retweet lang:es"
tweets = client.search_recent_tweets(query=query, tweet_fields=['id','text','created_at','author_id','geo','note_tweet'], max_results=79)
